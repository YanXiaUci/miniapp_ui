...
interface AmusementParkAddWeatherServicePageProps {
  referralData: AmusementParkReferralData;
  onBack: () => void;
  onComplete: () => void;
}

function AmusementParkAddWeatherServicePage({ referralData, onBack, onComplete }: AmusementParkAddWeatherServicePageProps) {
      ...
      <div className="w-[375px] bg-gray-50 min-h-screen flex flex-col relative">
        ...
        <div className="flex-1 overflow-y-auto bg-gray-50 pb-32">
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 border-l-4 border-blue-500 mx-4 mt-3 p-4 rounded-r-xl shadow-sm">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-gray-900 mb-1">来自 {referralData.parkName}</p>
                <p className="text-xs text-gray-600 leading-relaxed">
                  游乐园信息已自动填入，请继续完成天气保障流程
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl mx-4 mt-3 px-4 py-4 shadow-sm">
            ...
            <div className="flex items-center justify-between">
              <span className="text-base text-gray-900 font-medium">平顶山市鲁山县</span>
              <span className="text-sm text-gray-500">每日门票费用 ¥{referralData.amount}</span>
            </div>
          </div>
            ...
            <div className="bg-blue-50 rounded-xl p-3.5">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0" style={{ backgroundColor: '#5B6FED' }}></div>
                  <p className="text-sm text-gray-700 leading-relaxed">
                    陪你天气®将向您退还<span className="font-semibold text-sm" style={{ color: '#5B6FED' }}>{referralData.compensationAmount}元/天</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl mx-4 mt-3 mb-4 px-4 py-4 shadow-sm">
            ...
            <div className="bg-blue-50 rounded-xl p-2.5 mb-2.5">
              <p className="text-xs text-gray-600 leading-relaxed">
                陪你天气仅保障游玩期间的天气，如有需要，我们将要求您提供门票凭证以核实补偿。
              </p>
            </div>
...
export default AmusementParkAddWeatherServicePage;

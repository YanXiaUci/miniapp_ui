...
import { scenicSpots, ScenicSpot } from './scenicData';

interface ScenicListPageProps {
  onBack: () => void;
  onSelectScenic: (spot: ScenicSpot) => void;
}

function ScenicListPage({ onBack, onSelectScenic }: ScenicListPageProps) {
      ...
      <div className="w-[375px] bg-gray-50 min-h-screen flex flex-col relative">
        ...
        <div className="sticky top-0 bg-white z-20 px-6 pt-16 pb-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900">选择演示景区</h1>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-orange-800 leading-relaxed">
                以下是模拟的第三方景区小程序。选择任一景区进入对应页面，体验天气保障集成流程。
              </p>
            </div>
          </div>
        </div>
              ...
              >
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-700">
                    ...
                    <span>{spot.type === 'reservation' ? '预约制景区' : '现场购票景区'}</span>
                  </div>
                </div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-200/60 flex items-center justify-between">
                  ...
                  <span className="text-xl font-bold text-gray-900">¥{spot.ticketPrice}</span>
                </div>
              </button>
            ))}
          </div>

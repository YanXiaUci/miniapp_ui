      ...
      <div className="w-[375px] bg-gray-50 min-h-screen flex flex-col relative">
        ...
        <div className="flex-1 flex flex-col px-6 pt-16">
          <div className="text-center mb-4">
            <button className="p-2 hover:bg-gray-100 rounded-full transition-colors inline-flex items-center gap-1">
              <span className="text-sm text-gray-600">行程</span>
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            <div className="mb-12">
              <div className="flex items-center justify-center gap-2 mb-8">
                <div className="flex items-center">
                  ...
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 -ml-3 flex items-center justify-center">
                    <div className="w-6 h-6 bg-blue-400 rounded-full"></div>
                  </div>
                </div>
                <h1 className="text-3xl font-bold text-gray-900" style={{ color: '#5B6FED' }}>陪你天气</h1>
              </div>
            ...
            <div className="w-full">
              <button
                onClick={handleLogin}
                disabled={!agreed}
                className="w-full py-4 rounded-2xl text-white font-semibold text-base transition-all shadow-sm active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed mb-8"
            ...
            <div className="flex items-start gap-2.5 mb-3">
              ...
              >
                <div className={`w-5 h-5 rounded-sm flex items-center justify-center border-2 transition-all ${
                  agreed ? 'bg-white border-gray-300' : 'border-gray-300'
                }`}>
                  {agreed && (
        ...
        <div className="fixed bottom-0 w-[375px] bg-white border-t border-gray-200 py-3">

                ...
                <div className="p-7">
                    <div className="flex gap-3 items-stretch mb-8">
                        ...
                        <div className="flex-[1.4] flex flex-col justify-between pt-1 min-w-0">
                            <div className="space-y-1">
                                ...
                                <div className="text-[15px] font-extrabold text-slate-900 leading-tight whitespace-nowrap">
                                    即自动补偿 <span className="text-[#4667F2]">¥{compensationAmount}元/天</span>
                                </div>
                            </div>
                        ...
                        <div className="flex-1 flex flex-col justify-between pl-1 gap-3 pt-1 min-w-0">
                            ...
                            <div className="flex gap-2 items-start">
                                <div className="mt-0.5 text-slate-800 shrink-0 w-3.5 flex justify-center">
                                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M17.5 19c0-1.7-1.3-3-3-3h-11c-1.7 0-3 1.3-3 3s1.3 3 3 3h11c1.7 0 3-1.3 3-3z"></path><path d="M17.5 13a6 6 0 0 0-11.66 1.8"></path></svg>
                                </div>
                                <div className="space-y-0.5 min-w-0">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            onClick={onClose}
                            className="w-full py-3 rounded-xl font-bold text-slate-500 bg-slate-50 hover:bg-slate-100 active:scale-[0.98] transition-all text-sm"
                        >
                            暂不需要
                        </button>
                        <button
                            onClick={onAdd}
                            className="w-full py-3 rounded-xl font-bold text-white bg-[#4667F2] hover:bg-[#3b5bd6] active:scale-[0.98] shadow-lg shadow-blue-200/50 transition-all text-sm"
                        >
                            加购保障
                        </button>
                    </div>
